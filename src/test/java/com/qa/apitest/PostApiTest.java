...
public class PostApiTest extends TestBase {
	...
	public void postApiTest() throws JsonGenerationException, JsonMappingException, IOException {
		...
		user = new Users("Samuuxxa", "bhitte","samuuxa.bhitte@test12efr.com","female");
		...
		CloseableHttpResponse closeableHttpResponse = restClient.postAPI(uri, headersMap, jsonString);
